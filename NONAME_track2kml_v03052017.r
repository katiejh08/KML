NONAME.track2kml <- function (latitude, longitude, datetime, altitude = NULL, col.variable = NULL, 
    col.scheme = NULL, point.alpha = 255, line.color = "goldenrod", 
    line.alpha = 255, size.variable = NULL, 
    data.variables = NULL, output.filename = "track", descriptive.filename = NULL) 
{
    ...
    write("\t  <![CDATA[Generated using <a href=\"http://sites.google.com/site/michaelukemp/rncep\">RNCEP</a>]]>", 
        filename, append = TRUE)
    write("\t</description>", filename, append = TRUE)
